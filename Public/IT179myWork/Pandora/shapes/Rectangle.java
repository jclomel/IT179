...
public class Rectangle extends Shape {
   ...
   * If an argument is {@literal <=} 0, the default size specified in
  ...
  /**
   * Get the surface area of this <tt>Rectangle</tt>. (length*height;)
   ...
   * If <tt>theLength</tt> is {@literal <= 0}, the dimension is unchanged.
   ...
   * If <tt>theHeight</tt> is {@literal <= 0}, the dimension is unchanged.
